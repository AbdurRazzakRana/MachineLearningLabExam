...
classes = ['001','002','003', '004', '006', '009', '012', '014', '015', '016', '101', '102',
           '103', '104', '105', '106', '107', '108', '110', '111', '112', '113', '114', '115',
           '116', '117', '118', '119']
...
for i in files:
    ...
    saver = tf.train.import_meta_graph('ML-signature-verification.meta')
